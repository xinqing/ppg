...
class PayController extends Controller
{
	...
	{	
		...
		if($result['IsBizSuccess']){
			...
			$aop->appId = '2016110902653961';
			$aop->rsaPrivateKeyFilePath = Yii::app()->basePath.'/extensions/Alipay/key/rsa_private_key_pkcs8.pem';
			$aop->alipayPublicKey=Yii::app()->basePath.'/extensions/Alipay/key/alipay_public_key.pem';
			$aop->apiVersion = '1.0';
			$aop->postCharset='utf-8';
			$aop->sign_type='RSA';
			$request = new AlipayTradeWapPayRequest ();
			$request->setNotifyUrl('http://frontapi.ppgbuy.com/notify_url.aspx');
			$request->setReturnUrl("m.ppgbuy.com/pay/alipayreturn");
			$request->setBizContent('{"subject":"PPG_'.$OrderId.'","out_trade_no":"'.$OrderId.'","total_amount":"'.$price.'","product_code":"QUICK_MSECURITY_PAY"}');
