...
class WeixinController extends Controller{
                ...
                case "event":
                    if($postObj->EventKey=='POSTER'){
                        ...
                        if(!file_exists($filename)){
                            ...
                            fwrite($myfile, $txt);
                            fclose($myfile);
                            $this->servicemore((string)$postObj->FromUserName);
                            $this->receiveEvent($postObj);
                        }
                    }else{
                      $this->receiveEvent($postObj);
                  ...
                  "name": "碰碰商城", 
                   "sub_button": [
                       
                         {
                            "type": "view", 
                            "name": "今日大牌", 
                            "url": "http://m.ppgbuy.com/site/active?brandname=%E7%B2%BE%E9%80%89%E4%B8%8A%E6%96%B0&hotbrandid=95"
                        },
                        {
                            "type": "view", 
                            "name": "每日精选", 
                             "url": "http://m.ppgbuy.com/site/active?brandname=%E7%83%AD%E9%94%80%E6%8E%A8%E8%8D%90&hotbrandid=59"
                        },
                        {
                            "type": "view", 
                            "name": "今日秒杀", 
  ...
  private function receiveEvent($object){
   ...
   /* function mergerImg($imgs, $path) {
    ...
    //创建客服账号  多图文
    public function servicemore($openid){
        $access_token=$this->access_token();
        $url = 'https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token='.$access_token;
        $data = '{
                    "touser":"'.$openid.'",
                    ...
                    "news":{
                        "articles": [
                         {
                             "title":"【碰碰购】千元红包砸疼你，送个Iphone7安慰你！",
                             "description":"【碰碰购】千元红包砸疼你，送个Iphone7安慰你！",
                             "url":"http://mp.weixin.qq.com/s?__biz=MzI3MTUwMzQ3OA==&tempkey=z0lSSNqbWW%2B8BlUD7WQguuRMAmDqN8ORiatJp%2B9TInD1GGElL%2F9nP9eYuAd07hhZS3olInGSvIwf704IG8FqdCjka9AarMamCRvNrNMh4BiQE6KJiFH7X141SB3YpObfccJ9QCCmtJqgK52M5TbE4A%3D%3D&chksm=6ac19b1b5db6120df4bdfb9476b2af72a59ea920d3783c7391ded70cfbf423074516c72e7508#rd",
                             "picurl":"http://m.ppgbuy.com/assets/v1/image/1.jpg"
                         },
                          {
                             "title":"碰碰购和东方卫视一起玩疯了",
                             "description":"碰碰购和东方卫视一起玩疯了",
                             "url":"http://mp.weixin.qq.com/s?__biz=MzI3MTUwMzQ3OA==&tempkey=z0lSSNqbWW%2B8BlUD7WQguuRMAmDqN8ORiatJp%2B9TInAg%2Fm8fKSbmkSUMGNZy93Ms9gJVtJVlPsoJcy4YyAsb3unkJ9bAXnbmF8tkeQQ4ZGWQE6KJiFH7X141SB3YpObfOjWgMP62Z%2BOIkrimni4l7g%3D%3D&chksm=6ac19b1b5db6120d9c0179934b160c8e5d352c6f2f3ce53241ace9ee427866b71046d28ef422#rd",
                             "picurl":"http://m.ppgbuy.com/assets/v1/image/2.jpg"
                         },
                          {
                             "title":"有了它，你才能当愉快当潮男",
                             "description":"有了它，你才能当愉快当潮男",
                             "url":"http://mp.weixin.qq.com/s?__biz=MzI3MTUwMzQ3OA==&tempkey=z0lSSNqbWW%2B8BlUD7WQguuRMAmDqN8ORiatJp%2B9TInCIiEajaS5ZxD9h1wUlGs6pKi5n3hxyRIaWAYfMIFFDAQF%2Fbrlyo0PXHZYwOsMWdiWQE6KJiFH7X141SB3YpObfSIelqQZtYoFHg5D4AuIzSA%3D%3D&chksm=6ac19b1b5db6120d4ee9cac1d14088d28324ab7c72d3562a4cbc78ccbf378825b0aac421ec03#rd",
                             "picurl":"http://m.ppgbuy.com/assets/v1/image/3.jpg"
                         }
                        ]
                      }
                 }';   
