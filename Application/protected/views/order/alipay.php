...
require_once(Yii::app()->basePath."\\extensions\\Alipay1\\alipay.config.php");
require_once(Yii::app()->basePath."\\extensions\\Alipay1\\lib\\alipay_submit.class.php");
...
//收银台页面上，商品展示的超链接，必填
$show_url = 'http://10.12.50.10:1010/order/pay';
