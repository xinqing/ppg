...
.addIMG{overflow: hidden;margin-top: 30px;padding:0px 4%;}
...
.addIMG_btn{border:1px dashed #e3e2e2;width: 70px;height: 70px;position:relative;text-align: center;font-size:13px;color: #999999;}
...
<header id="head_tit">
    ...
    <div class="head_tit_right next_step">
        发布
    </div>
</header>
<div class="HT_45"></div>
...
<div style="text-align:right;font-size:13px;color:#999;margin-right:4%;margin-top:20px;">不超过6张</div>
