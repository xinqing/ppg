...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            this.callBackFun = params.callBackFun;
        ...
        setGearTooth: function(data) {
            ...
            if (l > 0) {
                ...
                var itemStr = "";
               /* if (_self.index == 2) {
                    itemStr += '<div class="tooth" ref="-1">不限</div>';
                };*/
                for (var i = 0; i < l; i++) {
                    if (_self.index != 2) {
        ...
        finish: function(e) {
          ...
          /*  if(!provinceVal){provinceVal=0;}*/
           ...
           /* if(!countyVal){countyVal=0;}*/
            ...
            _self.trigger.value = ((provinceText)?('' + provinceText):(''))+((cityText)?('' + cityText):(''))+((countyText)?('' + countyText):(''));
            ...
            if (_self.callBackFun)  {
                var arry = {};
                arry.provinceCode = provinceCode;
                arry.provinceText = provinceText;
                arry.cityCode = cityCode;
                arry.cityText = cityText;
                arry.countyCode = countyCode;
                arry.countyText = countyText;
                _self.callBackFun(arry);
            }
            _self.close(e);
        },
        close: function(e) {
